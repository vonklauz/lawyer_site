          ...
          >
            ...
            <div className="flex flex-col gap-4 bg-white rounded-2xl w-full max-w-md">
              ...
              <div className="text-sm text-gray-700 space-y-3">
                {schema?.map(({ title, type, name, id }: SchemaField) => {
                  const value = id ? details[id] : details[name];
                  const isDateField = type === "date" || type === "DATE";
              ...
              <div className="flex flex-col gap-2 mt-4">
                <button
                  ...
                  className={`py-2 rounded-md font-medium text-white transition ${
                    checked ? "blue-bg" : "bg-indigo-300 cursor-not-allowed! "
                  }`}
                >
                  Сохранить
                </button>
