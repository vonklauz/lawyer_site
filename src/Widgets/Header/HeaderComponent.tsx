      ...
      <div className={styles.headerTop}>
        <div className="container">
          <div className="flex mx-[-15px] divide-x-1 divide-gray-300">
            <div
              className={`w-33 flex items-center flex-1 ${styles.headerItem}`}
            >
              <img
            ...
            <div
              className={`w-33 flex items-end justify-end flex-1 ${styles.headerItem}`}
            >
              <div className="flex items-center justify-center gap-3">
                <div
                  className={`${styles.headerTopIcon} relative cursor-pointer`}
                >
                ...
                >
                  ...
                  <span className="absolute -top-1 -left-1 w-3 h-3 rounded-full bg-red-600 text-white text-[8px] font-bold flex items-center justify-center">
                    10
                  </span>
                </div>
                <div
